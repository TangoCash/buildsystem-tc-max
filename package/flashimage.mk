...
flash-image-hd60-multi-disk: atools $(DL_DIR)/$(HD60_BOOTARGS_SRC) $(DL_DIR)/$(HD60_PARTITONS_SRC) $(DL_DIR)/$(HD60_RECOVERY_SRC)
	...
	rm -rf $(IMAGE_BUILD_DIR) || true
	mkdir -p $(IMAGE_BUILD_DIR)/$(BOXMODEL)
	unzip -o $(DL_DIR)/$(HD60_BOOTARGS_SRC) -d $(IMAGE_BUILD_DIR)
	unzip -o $(DL_DIR)/$(HD60_PARTITONS_SRC) -d $(IMAGE_BUILD_DIR)
	unzip -o $(DL_DIR)/$(HD60_RECOVERY_SRC) -d $(IMAGE_BUILD_DIR)
